  ...
  return (
    <div id="wd-kanbas-navigation" style={{ width: 120 }}
      ...
      <Link to="/Kanbas/Account" id="wd-account-link"
        className={`list-group-item text-center border-0 ${location.pathname.startsWith("/Kanbas/Account") ? "bg-white text-danger" : "bg-black text-white"}`}>
        <FaRegCircleUser className={`fs-1 ${location.pathname.startsWith("/Kanbas/Account") ? "text-black" : "text-white"}`} /><br /> Account
      </Link>
      ...
      <Link to="/Kanbas/Courses/0000" id="wd-course-link"
        className={`list-group-item text-center border-0 ${location.pathname.startsWith("/Kanbas/Courses") ? "bg-white text-danger" : "bg-black text-white"}`}>
